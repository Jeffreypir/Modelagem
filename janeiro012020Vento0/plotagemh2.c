...
/*==================== PROGRAM ==============================
 * Program: plotagemh2.c 
 * Description: plotagem of H2 
...
int main(void){
	...
	fprintf(gp,"set output 'sploth2.pdf'\n");
	fprintf(gp,"set multiplot \n");
	fprintf(gp,"set title 'Geração da Hidrelétrica 2' \n");
	...
	fprintf(gp,"set arrow from 18,0 to 9,6300 nohead ls 2 \n");
	fprintf(gp,"set arrow from 22,0 to 19.7,6300 nohead ls 2 \n");
	...
	fprintf(gp,"plot [18:22] [0:3000] 'plot.txt' using 1:3 with linespoints lc 2 pt 7 ps 0.4 notitle \n");
