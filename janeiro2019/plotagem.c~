...
int main(void){
	...
	fprintf(gp,"set key font 'Helvetica,10' \n");
   	fprintf(gp,"set xrange [0:724] \n");
   	fprintf(gp,"set xrange [0:46000] \n");
	fprintf(gp,"set xlabel 'Tempo (h)'\n");
	fprintf(gp,"set ylabel 'MWh' \n");
	fprintf(gp,"plot [0:724] [0:46000] 'plot.txt' using 1:2 with linespoints lc 6 pt 2 ps 0.2 t'Hidrelétrica 1' \n");
   	fprintf(gp,"set key right bottom \n");
	fprintf(gp,"set key font 'Helvetica,10' \n");
   	fprintf(gp,"set xrange [0:724] \n");
   	fprintf(gp,"set xrange [0:46000] \n");
	...
	fprintf(gp,"set ylabel 'MWh' \n");
	fprintf(gp,"set size 0.5,0.5 \n");
	fprintf(gp,"plot [0:724] [0:46000] 'plot.txt' using 1:3 with linespoints lc 2 pt 2 ps 0.2 t'Hidrelétrica 2' \n");
	fprintf(gp,"set key right bottom \n");
	fprintf(gp,"set key font 'Helvetica,10' \n");
	...
	fprintf(gp,"set ylabel 'MWh' \n");
	fprintf(gp,"set size 0.5,0.5 \n");
	fprintf(gp,"plot [0:724] [0:46000] 'plot.txt' using 1:4 with linespoints lc 7 pt 2 ps 0.2 t'Termelétrica 1' \n");
	fprintf(gp,"set key right bottom \n");
	fprintf(gp,"set key font 'Helvetica,10' \n");
	fprintf(gp,"set xlabel 'Tempo (h)'\n");
	fprintf(gp,"set ylabel 'MWh' \n");
	fprintf(gp,"set size 0.5,0.5 \n");
	fprintf(gp,"plot [0:724] [0:46000]'plot.txt' using 1:5 with linespoints lc 4 pt 2 ps 0.2 t'Termelétrica 2' \n");
