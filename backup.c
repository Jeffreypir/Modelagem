 ...
 *       Revision:  seg 22 jun 2020 14:39
...
void PDDE(double dem, double prod, double pb){
			/* Contador para preenchiento do arquivo*/
          ...
          /*========================================================================================================*/
		   ...
		   double PRODUTIBILIDADE[2] = {1.0,prod};

		   /* Atividade das térmicas associadas as Hidroletricas 1 e 2 respectivamente */
		   double G1 = 0.0, G2 = 0.0; 

		   /* Definido a demanda a ser atingida 1 estagio */
		   //double DEMANDAs1[2]= {dem,10000};
		   double DEMANDAs1[2]= {dem,0.0};

		   /* Definindo os volumes minimos de operacao da hidreletrica no primeiro estagio*/
		   double VH1min = 900.0;
		   double VH2min = 500.0;
		   ...
		   double VINH1 = 40000.0;  // Hidroeletrica 1
		   double VINH2 = 40000.0;  // Hidroeletrica 2
		   ...
		   /* Definindo os volumes minimos de operacao da hidreletrica no cenario 1 */
		   double VH1min_1 = 800.0;                                                           		  
		   double VH2min_1 = 300.0;                                                           		   

		   /* Definindo o volume inicial das Usinas */
		   double VINH1_1 = 80000.0;  // Hidroeletrica 1
		   double VINH2_1 = 70000.0;  // Hidroeletrica 2
		  ...
		  /* Definindo os volumes minimos de operacao da hidreletrica no cenario 2*/
		   double VH1min_2 = 500.0;                                                           		  
		   double VH2min_2 = 500.0;                                                           		   
		   ...
		   /*==================================== INICIO ========================================================= */
		   /* Definido a demanda a ser atingida 2 estagio */
		   double DEMANDAs2_2[2]= {500.0,200.0};
		  ...
		  double sup_1[500+1];          // Vetor com os valores limites superiores para o cenário 1
		  double sup_2[500+1];          // vetor com os valores limites superiores para o cenário 2 
		  double inf_1[500+1];          // Vetor com os valores limites inferiores para o cenário 1  
		  double inf_2[500+1];          // Vetor com os valores limites inferiores para o cenário 2
		  ...
		  glp_set_obj_coef(ld_1,3,VH1min_1);
		  glp_set_obj_coef(ld_1,4,VH2min_1);
     ...
     matriz_variavel_1[1][0] = -TERMICAS*u2_1                       ,matriz_variavel_1[1][1] =  0*u2_1          ,matriz_variavel_1[1][2] =  0*u2_1;
   	 matriz_variavel_1[2][0] = (VH1min_1)*u3_1                      ,matriz_variavel_1[2][1] =  0*u3_1          ,matriz_variavel_1[2][2] =  0*u3_1;
     matriz_variavel_1[3][0] = (VH1min_2)*u4_1                      ,matriz_variavel_1[3][1] =  0*u4_1          ,matriz_variavel_1[3][2] =  0*u4_1;
	 matriz_variavel_1[4][0] = (-VINH1_1 - VOLI1_1)*u5_1            ,matriz_variavel_1[4][1] =  VTH1S1*u5_1     ,matriz_variavel_1[4][2] =  VVH1S1*u5_1;
	 matriz_variavel_1[5][0] = (-VINH2_1 - VOLI1_2)*u6_1            ,matriz_variavel_1[5][1] = -VTH2S1*u6_1     ,matriz_variavel_1[5][2] = -VVH2S1*u6_1;
	/*========================================================= FIM ========================================================================== */
		...
		/* ===================================================== INICO ======================================================================= */
		  ...
		  glp_set_obj_coef(ld_2,3,VH1min_2);
		  glp_set_obj_coef(ld_2,4,VH2min_2);
     ...
     matriz_variavel_2[1][0] = -TERMICAS*u2_2                         ,matriz_variavel_2[1][1] =  0*u2_2       ,matriz_variavel_2[1][2] =  0*u2_2;
  	 matriz_variavel_2[2][0] = (VH1min_2)*u3_2                        ,matriz_variavel_2[2][1] =  0*u3_2       ,matriz_variavel_2[2][2] =  0*u3_2;
     matriz_variavel_2[3][0] = (VH2min_2)*u4_2                        ,matriz_variavel_2[3][1] =  0*u4_2       ,matriz_variavel_2[3][2] =  0*u4_2;
	 matriz_variavel_2[4][0] = (-VINH1_2 - VOLI1_2)*u5_2              ,matriz_variavel_2[4][1] =  VTH1S1*u5_2  ,matriz_variavel_2[4][2] =  VVH1S1*u5_2;
   	 matriz_variavel_2[5][0] = (-VINH2_2 - VOLI2_2)*u6_2              ,matriz_variavel_2[5][1] = -VTH2S1*u6_2  ,matriz_variavel_2[5][2] = -VVH2S1*u6_2;
	   /*===================================================== FIM =========================================================================== */
		...
		/*============================================ INICIO ================================================================================ */
 		...
 		/* ============================FIM============================================= */
		  ...
		  glp_set_row_bnds(lp,3,GLP_UP,-100.0,-VH1min); 
		  ...
		  glp_set_row_bnds(lp,4,GLP_UP,-100.0,-VH2min); 
		  ...
		  /* Preechimento dos valores da matriz das restrições linha 14 */
		    ...
		    ia[107]  = 14, ja[107] = 3, ar[107]  =  soma_2[3][3];                 /* a[11,3] */
		...
		//FILE *arq2;
		//arq2 = fopen("dPlot.txt","a");
		//fprintf(arq2," %lf  %lf  %lf  %lf \n",PRODUTIBILIDADE[0]*VTH1S1,PRODUTIBILIDADE[1]*VTH2S1,G1,G2); 
		//fclose(arq2);
