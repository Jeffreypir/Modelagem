...
int main(void){
	...
	fprintf(gp,"set title 'Curva da Geração' \n");
	fprintf(gp,"set output 'watts.pdf'\n");
	...
	fprintf(gp,"plot [0:24] 'watts.txt' using 1:2 with linespoints lc 6 pt 7 ps 0.5 t'Geração'\n");
    fclose(gp);
