...
# include <math.h>   /* math */
# define ERRO 100   /* Erro associado */
...
void PDDE(double dem, double prod, double pb){
          ...
          /*========================================================================================================*/
		   ...
		   double DEMANDAs2_1[2]= {700.0,0.0};
		  ...
		  /* Definindo os volumes minimos de operacao da hidreletrica no cenario 2*/
		   ...
		   /*==================================== INICIO ========================================================= */
		   /* Definido a demanda a ser atingida 2 estagio */
		   double DEMANDAs2_2[2]= {700.0,0.0};
	   ...
	   /*===================================================== FIM =========================================================================== */
		...
		/*============================================ INICIO ================================================================================ */
		  ...
		  if (j >= 1){
			...
			/* Guardando os valores que a serem utilizados nos cortes de benders*/
		  ...
		  printf ("z = %g; VTH1S1 = %g; VVH1S1 = %g;VTH2S1 = %g;VVH2S1 = %g; G1 = %g; G2 = %g; AI = %g \n \n", z,VTH1S1,VVH1S1,VTH2S1,VVH2S1,G1,G2, ALFA1_1); 
			  if (j >= 4){
				  goto start;
		  }
